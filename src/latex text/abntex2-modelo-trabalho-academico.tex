...
Utilizando a \textbf{\color{red}Regra de Leibniz (enunciar/provar o teorema de derivação sob o sinal de integração)} e aplicando regra da cadeira, podemos escrever a derivada de (\ref{eqn:int_funcional_approx}) como
...
de onde, fazendo $\frac{\partial Y}{\partial \epsilon}=\eta$ e $\frac{\partial Y'}{\partial \epsilon}=\eta '$, obtemos a integral
...
\right )dx \text{, }
\end{equation}
de onde, integrando o segundo membro por partes e, a partir da condição necessária (\ref{eqn:cap_calcvar_condition}), temos
$$
I'(0)=\int_{x_1}^{x_2}\left (
