	...
	\encapsulateBackgroundLessFrames{
		\begin{frame}
			\begin{figure}[h]
				...
				\\{\footnotesize Fonte: \citeonline[p. 5]{deep_ritz}.}
			\end{figure}
		\end{frame}
	}
		...
		\begin{frame}
			\begin{figure}[h]
				...
				\begin{tikzpicture}
					...
					\node at (2.5,-2) {$l$};
				\end{tikzpicture}
				\\{\footnotesize Fonte: \citeonline[p. 25]{mefassan}.}
			\end{figure}
		\end{frame}
	}
...
print("Maxima deflexao: ", maxdef)
	...
	\begin{frame}
		...
		{\color{red}Explicar sobre o uso da Linguagem Python e as funções triangulares.}
	\end{frame}
