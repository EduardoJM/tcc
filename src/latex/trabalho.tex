...
\textbf{Palavras-chave}: Cálculo Variacional. Equação de Euler-Lagrange. Método de Rayleigh-Ritz. Programação. \textit{Python}.
\end{resumo}
...
A construção do sistema $M\cdot A=B$ e sua resolução, pelo \index[remissivo]{Método de Gauss-Jordan}método de Gauss-Jordan, será implementado na linguagem de programação \textit{Python} na Seção \ref{sec:python_triangular} do Capítulo \ref{cap:python}.
