...
{\color{red}Trocar membro por parcela.}
...
Substituindo $y$ por $v$ no funcional, $I$ passa a ser uma função de $a_1$, $a_2$, $\dots$, $a_n$. Assim, sua condição de estacionariedade será data por {\color{red}continuar}.

{\color{red}aplicando a condição de estacionáriedade, $\delta I=0$, tem-se
$$
	\delta I
	=
...
\chapter{Resolução de sistemas lineares com python}
