...
\begin{figure}[!h]
	...
	\begin{tikzpicture}
		...
		% y(x)
		\tkzFct[domain=2.5:4.6,samples=800]{-exp(-x+3.2)+4}
		% eta(x)
		\tkzFct[domain=2.5:4.6,samples=800]{-0.18*x*x+1.29*x-2.09}
		% y(x) + 2*eta(x)
		\tkzFct[domain=2.5:4.6,samples=800,dashed]{-exp(-x+3.2)+4+2*(-0.18*x*x+1.29*x-2.09)}
		% y(x) - 4*eta(x)
		\tkzFct[domain=2.5:4.6,samples=800,dashed]{-exp(-x+3.2)+4-4*(-0.18*x*x+1.29*x-2.09)}
...
\textit{\color{red}Testar sobre grossura de linha e melhor exibição.}
