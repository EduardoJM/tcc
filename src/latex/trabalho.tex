...
\begin{solution}
	...
	Fazendo a derivada em \eqref{eqn:ex_reta_prim_deriv}, tem-se como resultado
	$$
		\frac{
			y''(x)\sqrt{1+(y'(x))^2}
			-
		...
		=0\text{,}
	$$
	onde, devido ao fato de que o denominador $1+(y'(x))^2\geqslant 1$, pode-se analisar apenas o numerador, ou seja,
	$$
		y''(x)\sqrt{1+(y'(x))^2}
		-
		\frac{(y'(x))^2 y''(x)}{
