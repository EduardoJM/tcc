...
Exemplificando, \citeonline{RRM_Applications} trata do problema de encontrar as frequências naturais em um tipo especial de viga, chamada de consola, que é uma viga apoiada apenas em uma de suas extremidades (Ver Figura \ref{fig:cantilever}). Na Figura \ref{fig:cantilever}, a função $w(x,t)$ representa o deslocamento dinâmico.
