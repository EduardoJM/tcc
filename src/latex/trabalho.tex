...
O operador $\delta$ é denominado operador variacional. O operador compartilha algumas propriedades com o operador diferencial relativamente à variável dependente.

{\color{red}Falar sobre a diferença entre $\delta f$ e $df$.}
