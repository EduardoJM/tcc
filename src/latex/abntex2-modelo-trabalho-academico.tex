...
\label{apend:regra_de_leibniz}
{
	...
	Isso equivale a dizer que uma função $f$ satisfazendo a hipótese do Teorema \ref{teorema:func_uniformemente} é uniformemente contínua.
	...
	\begin{teorema}[Derivação sob o sinal de integral]
		...
		\begin{proof}
			...
			Pelo \textbf{\color{red}Teorema (do Valor Médio?)}, existe $\theta \in [0,1]$ de modo que
			$$
