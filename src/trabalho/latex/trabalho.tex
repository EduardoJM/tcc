...
\documentclass[
	...
	a4paper,			% tamanho do papel (folhas A4).
...
\usepackage{color}				% Pacote para o uso de cores no documento
\usepackage{graphicx}			% Pacote para a inclusão\manipulação de imagens
...
%
% Configuração e criação de ambientes matemáticos
% 
% Ambiente para criação de matriz
...
\usetkzobj{all}
% ---
% Pacotes para a inclusão de códigos e syntax highlight
% ---
\usepackage{listings}
...
% Recria o comando \fonte para adequações
\makeatletter
...
\makeatother
% Comando para inserir fonte nos códigos
\newcommand{\codigofonte}{
	\vspace{-0.4cm}
	\fonte{Elaborado pelo autor, 2019.}
	\vspace{0.4cm}
}
% Cria um comando para reduzir o espaçamento vertical de equações
\makeatletter
\newcommand{\noEquationSpacing}[1]{
	{
...
% Backref para a escrita do trabalho (indica onde as referências são citadas)
...
% Os códigos acima são utilizados apenas para controle de referências
% durante a escrita. Para a compilação final e/ou impressão, utilizar
...
% pacote utilizado para incluir pdfs como página
% por exemplo, a ficha catalografica e a folha de
% aprovação
\usepackage{pdfpages}
...
% ---
% compila os indices (sumário e indice remissivo)
% ---
\makeindex
